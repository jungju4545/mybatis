...
<link rel="stylesheet"
	href="../resources/vendors/linericon/style.css">
<link rel="stylesheet"
...
<link rel="stylesheet"
	href=" ../resources/vendors/jquery-ui/jquery-ui.css">
<!-- main css -->
						...
						<ul class="nav navbar-nav menu_nav">
							...
							<li class="nav-item submenu dropdown"><a href="#"
								...
								<ul class="dropdown-menu">
									<li class="nav-item"><a class="nav-link"
										href="single-blog.html">Sinlge Blog</a></li>
									<li class="nav-item"><a class="nav-link"
				...
				<div class="col-lg-8">
					<div class="blog_left_sidebar">
						<article class="blog_style1">
							<div class="blog_img">
								<img class="img-fluid" src="../resources/img/home-blog/blog-1.jpg" alt="">
							</div>
							<div class="blog_text">
								<div class="blog_text_inner">
									<div class="cat">
										<a class="cat_btn" href="#">Gadgets</a> <a href="#"><i
											class="fa fa-calendar" aria-hidden="true"></i> March 14, 2018</a>
				...
				<div class="col-lg-3 col-md-6 col-sm-6">
					<div class="single-footer-widget instafeed">
						...
						<ul class="list instafeed d-flex flex-wrap">
							<li><img src="../resources/img/instagram/Image-01.jpg" alt=""></li>
							<li><img src="../resources/img/instagram/Image-02.jpg" alt=""></li>
							<li><img src="../resources/img/instagram/Image-03.jpg" alt=""></li>
							<li><img src="../resources/img/instagram/Image-04.jpg" alt=""></li>
							<li><img src="../resources/img/instagram/Image-05.jpg" alt=""></li>
							<li><img src="../resources/img/instagram/Image-06.jpg" alt=""></li>
							<li><img src="../resources/img/instagram/Image-07.jpg" alt=""></li>
							<li><img src="../resources/img/instagram/Image-08.jpg" alt=""></li>
						</ul>
					</div>
				</div>
